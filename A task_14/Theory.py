...
# 2. Значащие нули - любой нуль, которые стоит где-то внутри числа
...
# В записи чисел переменной x обозначена неизвестная цифра из алфавита 22 системы счисления.
...
# 3x75(80)+14x0(80)
# В записи чисел переменной x обозначена неизвестная цифра из алфавита 80 системы счисления.
...
# 123x5(15)+67y9(17)
# В записи чисел переменными x и y обозначены неизвестные цифры из алфавитов 15 и 17 систем счисления соответственно.
