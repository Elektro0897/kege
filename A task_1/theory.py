...
matr = 'все строки из матрицы'.split()
graf = 'все ребра из графа'.split()

print(*range(1, 8)) # количество столбцов в матрице
for i in permutations('названия вершин'):
    # for x, y in graf - извлекает рёбра из графа;
    ...
    # matr[i.index(y)] - сопоставляем вершину y с какой-то строкой в перестановке i;
